...
import com.gmsxo.domains.data.AppConfigData;
...
public class DBUtil {
 ...
 private static final String DBADDR="java:comp/env/jdbc/dm";
    ...
    try {
      ...
      if (TOMCAT) {
        ...
        configuration = new Configuration()
          ...
          .setProperty("hibernate.connection.datasource", DBADDR)
          ...
          .addAnnotatedClass(AppClass.class)
          .addAnnotatedClass(AppConfigData.class)
          .addAnnotatedClass(AppThread.class);
      }
      else {
        configuration = new Configuration()
        .setProperty("hibernate.connection.driver_class", "org.postgresql.Driver")
